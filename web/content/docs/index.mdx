...
description: Getting Started with Natural Commands
---
...
# The AI model to use (e.g., "anthropic/claude-3-opus-20240229")
...
<Cards>
  <Card title="Commands Guide" href="/docs/commands" />
  <Card title="OpenRouter Setup Guide" href="/docs/openrouter" />
</Cards>
